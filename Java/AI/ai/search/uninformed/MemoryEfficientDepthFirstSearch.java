...
public class MemoryEfficientDepthFirstSearch implements UninformedSearch
{
	...
	public MemoryEfficientDepthFirstSearch()
	{
		totalNumberOfNodes=0;
		stateSpaceEstimate=500;
	}
	public MemoryEfficientDepthFirstSearch(int passStateSpaceEstimate)
	{
		totalNumberOfNodes=0;
